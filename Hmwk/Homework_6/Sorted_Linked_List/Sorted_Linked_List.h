...
class Sorted_Linked_List{
    ...
    public:
        ...
        Sorted_Linked_List(){ head = NULL;}
        Sorted_Linked_List(const Sorted_Linked_List&);
        ~Sorted_Linked_List();
        void append(T);
        void insert(T);
        void delNode(T);
...
template <class T>
Sorted_Linked_List<T>::Sorted_Linked_List(const Sorted_Linked_List& obj){
/***************************************************************************//**
...
template <class T>
Sorted_Linked_List<T>::~Sorted_Linked_List(){
...
template <class T>
void Sorted_Linked_List<T>::append(T val){
/***************************************************************************//**
...
template <class T>
void Sorted_Linked_List<T>::delNode(T val){
...
template <class T>
void Sorted_Linked_List<T>::print()const{
/***************************************************************************//**
...
template <class T>
string Sorted_Linked_List<T>::toString(){
